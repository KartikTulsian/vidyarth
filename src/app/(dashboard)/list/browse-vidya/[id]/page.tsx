...
import SingleStuffClient from "./SingleStuffClient";
...
export default async function SingleStuffPage({
  params
}: {
        ...
        <div className="fixed bottom-6 right-5 z-[1000]">
          ...
          >
            <FormContainer
              table='trade'
              type='create'
              data={tradeFormData} // Pass the constructed data object
            />
